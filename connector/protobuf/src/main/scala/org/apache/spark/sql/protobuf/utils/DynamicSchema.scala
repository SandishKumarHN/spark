...
/**
 * DynamicSchema builder class for creating protobuf.proto files on the fly.
 * DynamicSchema aids in the creation of dynamic FileDescriptorSets and Protobuf descriptors.
 */
class DynamicSchema {
  private var fileDescSet: FileDescriptorSet = null

  /**
   * @param fileDescSet
   */
  private def this(fileDescSet: FileDescriptorSet) = {
    this
  ...
  private val messageDescriptorMapFull: util.Map[String, Descriptor] =
    new util.HashMap[String, Descriptor]()
  private val messageMsgDescriptorMapShort: util.Map[String, Descriptor] =
    new util.HashMap[String, Descriptor]()
  ...
  private def  init(fileDescSet: FileDescriptorSet) : util.Map[String, FileDescriptor] = {
    // check for dupes
  ...
  private def getMessageTypes(): util.Set[String] = {
  ...
  class Builder {
    private val messageFileDescProtoBuilder: FileDescriptorProto.Builder =
      FileDescriptorProto.newBuilder()
    private val messageFileDescSetBuilder: FileDescriptorSet.Builder =
