...
// scalastyle:on: object.name
   ...
   */
  @Experimental
  def to_protobuf(data: Column): Column = {
    new Column(CatalystDataToProtobuf(data.expr, None, None))
  }
  ...
  def to_protobuf(data: Column, descFilePath: String, messageName: String): Column = {
    new Column(CatalystDataToProtobuf(data.expr, Some(descFilePath), Some(messageName)))
  }
}
