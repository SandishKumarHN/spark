...
/**
 * The MessageDefinition builder class assists in the creation of protobuf Descriptors on the fly.
 * @param messageType
 */
class MessageDefinition(val messageType: DescriptorProto = null) {
  ...
  class Builder(msgTypeName: String) {
    ...
    private def addField(label: String, typeName: String, name: String, num: Int,
    ...
    private def addMessageDefinition(msgDef: MessageDefinition): Builder = {
    ...
    private def addField(label: FieldDescriptorProto.Label, typeName: String, name: String,
                         num: Int, defaultVal: String): DescriptorProto.Builder = {
